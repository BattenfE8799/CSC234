...
public:
    ...
    setup() {
        ...
        livingRoom.east = KITCHEN; //changed livingroom connection from dining room north to kitchen east
        ...
        diningRoom.north = KITCHEN; //Bronze-changed connected room and direction
        roomList.at(DINING_ROOM) = diningRoom;

        Room kitchen = Room(KITCHEN, "kitchen", "A small, dimly lit kitchen.");
        kitchen.west = LIVING_ROOM; //Bronze-changed connected room and direction
        kitchen.south = DINING_ROOM; //Bronze-changed connected room and direction
    ...
    void tour() {
        ...
        newLocation = currentRoom.east; //Bronze-changed current room direction
